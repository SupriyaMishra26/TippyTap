...
//   );
// }
// Central API service. Replace API_BASE with your real endpoint
// when you have one. All product fetching goes through here.

import nailImg from '../../assets/product-cherry.jpg';
...
const MOCK: ApiProduct[] = [
  ...
  { id: 'p-8', name: 'Rose Gold Glam', price: 749, image: nailImg, description: 'Luxe rose gold metallic finish.', category: 'best-sellers', rating: 5 },
  // Soft Gel collection
  { id: 'sg-1', name: 'Ocean Breeze', price: 499, image: nailImg, description: 'Cool turquoise soft-gel set with a glossy finish.', category: 'soft-gel', rating: 5, variants: ['Short', 'Medium', 'Long'] },
  { id: 'sg-2', name: 'Ruby Passion', price: 549, image: nailImg, description: 'Bold ruby red — timeless and iconic.', category: 'soft-gel', rating: 5, variants: ['Short', 'Medium', 'Long'] },
  { id: 'sg-3', name: 'Sunset Orange', price: 499, image: nailImg, description: 'Warm tangerine for bright, sunny days.', category: 'soft-gel', rating: 5, variants: ['Short', 'Medium'] },
  { id: 'sg-4', name: 'Soft Pink Blush', price: 479, image: nailImg, description: 'Delicate blush pink for everyday elegance.', category: 'soft-gel', rating: 5, variants: ['Short', 'Medium', 'Long'] },
  // Home collection cards
  { id: 'home-blushing-rose', name: 'Blushing Rose', price: 499, image: nailImg, description: 'Soft pink for everyday elegance.', category: 'home', rating: 5 },
  { id: 'home-sunset-pop', name: 'Sunset Pop', price: 499, image: nailImg, description: 'Warm orange with uplifting energy.', category: 'home', rating: 5 },
  { id: 'home-classic-red', name: 'Classic Red', price: 499, image: nailImg, description: 'Bold red — timeless and iconic.', category: 'home', rating: 5 },
  { id: 'home-ocean-breeze', name: 'Ocean Breeze', price: 499, image: nailImg, description: 'Cool turquoise for a fresh vibe.', category: 'home', rating: 5 },
];
